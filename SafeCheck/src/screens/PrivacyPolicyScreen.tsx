...
For the purposes of this Privacy Policy:
  ...
  * Application refers to SafeCheck, the software program provided by the
    Company.

  * Company (referred to as either "the Company", "We", "Us" or "Our" in this
    Privacy Policy) refers to SafeCheck.
  ...
  * Account Information
   ...
   Customer Support Data
     ...
     Support tickets and correspondence: up to 24 months from the date of
      ticket closure to resolve follow-up inquiries, track service quality, and defend against potential legal claims
...
If you have any questions about this Privacy Policy, You can contact us:
  ...
  By email: nafisanidhi05@gmail.com
...
function isLikelyHeading(line: string) {
  ...
  const shortEnough = trimmed.length <= 60;
  const noSentencePunctuation = !/[.:;]$/.test(trimmed);
  const notBullet = !trimmed.startsWith("•") && !trimmed.startsWith("-");

  return shortEnough && noSentencePunctuation && notBullet;
}
...
function renderPolicy(text: string) {
  ...
  for (const line of lines) {
    if (isLikelyHeading(line)) {
      flushParagraph();
      elements.push(
        <Text key={`h-${key++}`} style={styles.sectionTitle}>
          {line}
        </Text>
      );
    } else {
      ...
      >
        <View style={styles.heroCard}>
          ...
          <Text style={styles.subtitle}>
            Please read how SafeCheck handles your information.
          </Text>
        </View>

        <View style={styles.policyCard}>{renderPolicy(RAW_POLICY)}</View>

        <View style={styles.footerCard}>
          <Text style={styles.footerText}>
            If you have any questions about this Privacy Policy, please contact us
            using the details provided in the policy above.
          </Text>
        </View>
      </ScrollView>
    </ScreenBackground>
